...
public class RegisterController implements Initializable {
    ...
    private DB databaseConnection = DB.getInstance();
    ...
    public void Register(ActionEvent event) throws IOException {
        ...
        if (Check_for_errors() == true) {
            ...
            try {
                databaseConnection.addUser(Fullname.getText(), Email.getText(), Password.getText(), date, Gender.getValue());
                FXMLLoader loader = new FXMLLoader(getClass().getResource("App.fxml"));
                Parent root = loader.load();
                AppController controller = loader.getController();
                controller.userinfo = databaseConnection.retrieveUser(Email.getText());
                Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                Scene Scene = new Scene(root);
                stage.setScene(Scene);
                stage.show();
